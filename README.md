...
🏆 **Competitive programmer with 1,200+ problems solved on LeetCode with 1800+ max ratings globally** – demonstrating strong command of data structures, algorithms, and performance optimization.
...
- Debugged UI bugs and cross-browser compatibility issues across Chrome, Firefox, and Safari.
